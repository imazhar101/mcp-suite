...
export const stripeTools: Tool[] = [
  // Connection test
  {
    ...
    description:
      'Test the connection to Stripe API and retrieve account information',
    inputSchema: {
      type: 'object',
      properties: {},
      required: [],
    ...
    inputSchema: {
      ...
      properties: {
        limit: {
          type: 'number',
          description:
            'Maximum number of payment intents to return (default: 10)',
        },
        customer: {
          type: 'string',
    ...
    inputSchema: {
      ...
      properties: {
        ...
        charge: {
          type: 'string',
          description:
            'The charge ID to refund (alternative to payment_intent)',
        },
        amount: {
          type: 'number',
          description:
            'Amount to refund in smallest currency unit (optional, defaults to full amount)',
        },
        reason: {
          type: 'string',
    ...
    inputSchema: {
      ...
      properties: {
        limit: {
          type: 'number',
          description:
            'Maximum number of subscriptions to return (default: 10)',
        },
        customer: {
          type: 'string',
          description: 'Filter by customer ID',
    ...
    inputSchema: {
      ...
      properties: {
        ...
        auto_advance: {
          type: 'boolean',
          description:
            'Whether to automatically advance through collection steps',
        },
        collection_method: {
          type: 'string',
